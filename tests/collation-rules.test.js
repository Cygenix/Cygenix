...
const WIRED = [
  ...
  /* mapper.html was the older Object Mapping screen and briefly appeared in
     this list. It is retired: /mapper now redirects to /object-mapping, so
     there is one mapping journey to keep wired rather than two. */
