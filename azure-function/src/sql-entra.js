...
//
// ── Keep in sync ───────────────────────────────────────────────────────────
// An identical copy lives at netlify/functions/lib/sql-entra.js. The two
// runtimes deploy separately so the file cannot simply be shared;
// tests/sql-entra.test.js asserts the copies have not drifted.
