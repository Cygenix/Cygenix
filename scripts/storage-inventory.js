...
const CLASSES = {
  ...
  'cygenix_datagen_selection':   ['A', 'Which tables the Data Generator had selected, per profile', 'synced (SYNC_KEYS)'],
  'cygenix_datagen_runs':        ['A', 'Which rows each Data Generator run inserted', 'synced (SYNC_KEYS), union-merged — the only record of what a run put there'],
  ...
  'cygenix_assurance_v1':        ['A', 'The Assurance store: rules, runs, breaches, tags, suggestions', 'NOT SYNCED — WI-1; Home reads its open breaches for the needs-you queue'],
